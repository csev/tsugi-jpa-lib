 ...
 */
@Transactional
public interface LtiServiceRepository extends PagingAndSortingRepository<LtiServiceEntity, Long> {
     ...
     * @return the LtiServiceEntity OR null if there is no entity matching this key
     */
    LtiServiceEntity findByServiceKey(String key);
}
